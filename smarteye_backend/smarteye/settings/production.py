...
# Production email backend (optional configuration)
...
LOGGING['handlers']['file']['level'] = env('LOG_LEVEL', default='INFO')
LOGGING['handlers']['console']['level'] = env('LOG_LEVEL', default='INFO')
