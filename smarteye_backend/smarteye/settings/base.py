"""
Django settings for SmartEye project.
...
ASGI_APPLICATION = 'smarteye.asgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'SmartEye API',
    'DESCRIPTION': 'Document analysis and accessibility conversion API',
    'VERSION': '1.0.0',
