...
@Service
@Transactional
public class DocumentAnalysisDataServiceOptimized {

    private static final Logger logger = LoggerFactory.getLogger(DocumentAnalysisDataServiceOptimized.class);
