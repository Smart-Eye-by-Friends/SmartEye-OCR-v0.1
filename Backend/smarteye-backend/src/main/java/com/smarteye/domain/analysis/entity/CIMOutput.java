...
public class CIMOutput {
    ...
    // Convenience method for setting content (same as cimData)
    public String getContent() { return cimData; }
    public void setContent(String content) { this.cimData = content; }
