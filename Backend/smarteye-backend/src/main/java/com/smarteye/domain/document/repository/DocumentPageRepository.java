package com.smarteye.domain.document.repository;
...
public interface DocumentPageRepository extends JpaRepository<DocumentPage, Long> {
    ...
    Optional<DocumentPage> findByAnalysisJobAndPageNumber(com.smarteye.domain.analysis.entity.AnalysisJob analysisJob, Integer pageNumber);
