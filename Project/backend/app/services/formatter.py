...
class ElementGroupBundle:
    ...
    ordered_elements: List[MockElement]


class TextFormatter:
    """
    정렬된 MockElement + OCR 텍스트를 받아 최종 포맷팅된 문자열을 생성한다.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            use_db_rules: True면 DB에서 덮어쓴 규칙을 반영 (현재는 매개변수만 유지).
            db_rule_records: 외부에서 주입한 규칙 덮어쓰기 정보.
        """
        ...
        self.rules = override_rules_with_db(base_rules, db_rule_records if use_db_rules else None)
    ...
    def format_page(
        ...
        *,
        ...
        """
        Args:
            sorted_elements: sorter가 반환한 MockElement 리스트 (order_in_question 필수).
            ocr_texts: element_id → 텍스트 딕셔너리 또는 MockTextContent 리스트.
